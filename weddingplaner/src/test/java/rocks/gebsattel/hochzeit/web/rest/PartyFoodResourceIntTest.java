...
public class PartyFoodResourceIntTest {
    ...
    private static final LocalDate DEFAULT_FOOD_BEST_SERVE_TIME = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_FOOD_BEST_SERVE_TIME = LocalDate.now(ZoneId.systemDefault());
    ...
    private static final Instant DEFAULT_FOOD_PROPOSAL_ACCEPT_TIME = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_FOOD_PROPOSAL_ACCEPT_TIME = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    @Autowired
    private PartyFoodMapper partyFoodMapper;
    ...
    public static PartyFood createEntity(EntityManager em) {
        PartyFood partyFood = new PartyFood()
            ...
            .foodProposalAcceptTime(DEFAULT_FOOD_PROPOSAL_ACCEPT_TIME)
    ...
    public void createPartyFood() throws Exception {
        ...
        PartyFoodDTO partyFoodDTO = partyFoodMapper.toDto(partyFood);
        restPartyFoodMockMvc.perform(post("/api/party-foods")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(partyFoodDTO)))
        ...
        assertThat(testPartyFood.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
        ...
        assertThat(testPartyFood.getFoodProposalAcceptTime()).isEqualTo(DEFAULT_FOOD_PROPOSAL_ACCEPT_TIME);
        assertThat(testPartyFood.getWeight()).isEqualTo(DEFAULT_WEIGHT);
    }
    ...
    public void getAllPartyFoods() throws Exception {
        ...
        restPartyFoodMockMvc.perform(get("/api/party-foods?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].foodProposalAcceptTime").value(hasItem(DEFAULT_FOOD_PROPOSAL_ACCEPT_TIME.toString())))
    ...
    public void getPartyFood() throws Exception {
        ...
        restPartyFoodMockMvc.perform(get("/api/party-foods/{id}", partyFood.getId()))
            ...
            .andExpect(jsonPath("$.foodProposalAcceptTime").value(DEFAULT_FOOD_PROPOSAL_ACCEPT_TIME.toString()))
    ...
    public void updatePartyFood() throws Exception {
        ...
        updatedPartyFood
            ...
            .foodProposalAcceptTime(UPDATED_FOOD_PROPOSAL_ACCEPT_TIME)
            .weight(UPDATED_WEIGHT);
        PartyFoodDTO partyFoodDTO = partyFoodMapper.toDto(updatedPartyFood);
        ...
        assertThat(testPartyFood.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
        ...
        assertThat(testPartyFood.getFoodProposalAcceptTime()).isEqualTo(UPDATED_FOOD_PROPOSAL_ACCEPT_TIME);
        assertThat(testPartyFood.getWeight()).isEqualTo(UPDATED_WEIGHT);
    }
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(PartyFoodDTO.class);
        PartyFoodDTO partyFoodDTO1 = new PartyFoodDTO();
        partyFoodDTO1.setId(1L);
        PartyFoodDTO partyFoodDTO2 = new PartyFoodDTO();
        assertThat(partyFoodDTO1).isNotEqualTo(partyFoodDTO2);
        partyFoodDTO2.setId(partyFoodDTO1.getId());
        assertThat(partyFoodDTO1).isEqualTo(partyFoodDTO2);
        partyFoodDTO2.setId(2L);
        assertThat(partyFoodDTO1).isNotEqualTo(partyFoodDTO2);
        partyFoodDTO1.setId(null);
        assertThat(partyFoodDTO1).isNotEqualTo(partyFoodDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(partyFoodMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(partyFoodMapper.fromId(null)).isNull();
    }
}
