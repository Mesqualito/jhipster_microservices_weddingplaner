...
@Component({
    selector: 'jhi-message-jo-angular',
    templateUrl: './message-jo-angular.component.html'
})
export class MessageJoAngularComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    loadAll() {
        this.messageService.query({
            ...
            sort: this.sort()}).subscribe(
                (res: HttpResponse<MessageJoAngular[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/message-jo-angular'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.router.navigate(['/message-jo-angular', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    trackId(index: number, item: MessageJoAngular) {
        return item.id;
    }
