...
@Component({
    selector: 'jhi-message-jo-angular-detail',
    templateUrl: './message-jo-angular-detail.component.html'
})
export class MessageJoAngularDetailComponent implements OnInit, OnDestroy {
