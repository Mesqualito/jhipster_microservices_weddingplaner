...
describe('Service Tests', () => {
    ...
    describe('PartyEventJoAngular Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(PartyEventJoAngularService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/party-events';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return PartyEventJoAngular', () => {
