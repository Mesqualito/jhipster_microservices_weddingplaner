...
describe('Service Tests', () => {
    ...
    describe('WeddingServiceJoAngular Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(WeddingServiceJoAngularService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/wedding-services';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return WeddingServiceJoAngular', () => {
